...
print(list_names())   # ['bollinger_mr', 'linear_mr', 'ma_crossover', 'vpa_breakout', 'vpa_reversal', 'vpa_trend']
result = run_strategy("linear_mr", prices)  # close-only strategy
result = run_strategy("vpa_trend", ohlcv)   # OHLCV strategy
```
